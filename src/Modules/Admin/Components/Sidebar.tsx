...
import { FaTachometerAlt, FaBox, FaTag, FaUsers, FaShoppingCart, FaChartPie, FaCog, FaSignOutAlt } from "react-icons/fa";
import { useNavigate } from "react-router-dom";
import { useDispatch } from "react-redux";
import { logout } from "../../User/Redux/reducer/AdminSlice";
...
const Sidebar = () => {
    ...
    return (
        <div className="w-68 h-screen bg-white shadow flex flex-col justify-between">
            ...
            <div>
                ...
                <ul className="mt-5">
                    <li className="flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center py-3 px-8" onClick={() => navigate("/admin")}>
                    ...
                    <li className="flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3" onClick={() => navigate("/admin/products")}>
                        <div className="flex items-center">
                    ...
                    <li className="flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3" onClick={() => navigate("/admin/category")}>
                        <div className="flex items-center">
                    ...
                    <li className="flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center  px-8 py-3" onClick={() => navigate("/admin/orders")}>
                        <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-puzzle" width={18} height={18} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
                                <path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1" />
            ...
            <div >
                <div className="flex items-center  mb-4 px-8 cursor-pointer " onClick={() => {
                    dispatch(logout());
                    navigate("/admin");
                }}>
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 text-sm font-medium">Logout</p>
                    </div>
                </div>
